...
export declare function PopupSchema({ portal }: {
    portal: PopupPortal;
...
export declare function applyTone(element: HTMLElement | SVGElement | null, color: MarkerData["color"]): void;
export declare function styleMarkerPin(element: HTMLElement | undefined, feature: MarkerData): HTMLElement | null;
